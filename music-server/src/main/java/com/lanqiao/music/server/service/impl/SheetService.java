...
//        }
    ...
    @Override
    public List<Sheet> search(User user) {
        return  sheetMapper.searchByUser(user.getUname());
    }

    @Override
    public List<Sheet> searchByCondition(String sname, int ssum, String scontext) {
        return sheetMapper.searchByCondition(sname,ssum,scontext);
    }

    @Override
    public List<Sheet> searchByNum(int minSum, int maxSum) {
